...
if (request.getParameter("MM_insert") != null && request.getParameter("MM_insert").toString().equals("form1")) {
  ...
  String MM_fieldsStr = "Name|value|CountryCode|value|District|value|Population|value";
  String MM_columnsStr = "Name|',none,''|CountryCode|',none,''|District|',none,''|Population|none,none,NULL";
...
<form method="post" action="<%=MM_editAction%>" name="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td>
        <input type="text" name="CountryCode" value="" size="32">
      </td>
    </tr>
    <tr valign="baseline">
