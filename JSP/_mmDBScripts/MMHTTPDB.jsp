	...
	try 
	{
		if (aResultSet != null)
		{
			...
			for(int i=1 ;i <= rMetaData.getColumnCount() ; i++)
			{
				...
				if (colName.equals("TABLE_CAT"))
				{
					xmlOutput = xmlOutput + "TABLE_CATALOG";
				}
				else if (colName.equals("TABLE_SCHEM"))
				{
					xmlOutput = xmlOutput + "TABLE_SCHEMA";
				}
				else if (colName.equals("PROCEDURE_CAT"))
				{
					xmlOutput = xmlOutput + "PROCEDURE_CATALOG";
					bUseProc = true;
				}
				else if (colName.equals("PROCEDURE_SCHEM"))
				{
					xmlOutput = xmlOutput + "PROCEDURE_SCHEMA";
					bUseProc = true;
				}
				else
				{
					if (bUseProc)
					{
						...
						{
							xmlOutput = xmlOutput + "PARAMETER_NAME";
						}
						else if (colName.equals("COLUMN_TYPE"))
						{
							xmlOutput = xmlOutput + "PARAMETER_TYPE";
						}
						else
						{
			...
			while (aResultSet.next())
			{
				...
				{
					String colName = rMetaData.getColumnName(i);
					boolean bIsParameterType = false;
					...
					if (aObject != null)
					{
						...
						else if (colName.equals("DATA_TYPE"))
						{
							...
							{
								aObject = MapSQLType2Name(aObject);
							}
						}
